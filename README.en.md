...
- **Current `main`:** the compile-ready ChIP-seq recipe, cross-workflow-family retrieval evaluation, and public evidence pages remain part of the evolving baseline.
