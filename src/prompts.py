...
def render_natural_language_planner_prompt(
    ...
    return (
        ...
        "- Use the retrieved approved catalog context below as the candidate recipe/tool context.\n"
        "- Use only tools and versions listed in the retrieved approved catalog context.\n"
